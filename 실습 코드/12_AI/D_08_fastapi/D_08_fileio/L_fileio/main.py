...
# 절대 경로
# reslove는 현재 파일 경로를 확실한 절대 경로(.이 없는)로 바꾼다.
# 실행 결과 : 🍩[기준 폴더] D:\정해원\Songpa-TIL\실습 코드\12_AI\D_08_fastapi\D_08_fileio\L_fileio
...
def main() -> None:
    ...
    copied = copy_binary("sample.txt", "sample_copy.bin") #문서의 값을 sample_copy.bin에 넣겠다.
    print("🍩binary 복사: ", copied, copied.stat().st_size, "bytes")
