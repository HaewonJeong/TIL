...
public class Children {
    /*
    * [접근 제한자]
    * 클래스 혹은 클래스의 멤버(필드)에 참조 연산자로 접근 할 수 있는 범위를 제한하기 위한 키워드
    *
    ...
    * */
    ...
    /*[Getter와 Setter 메소드]
    * Getter(접근자): 내부 핃드의 값을 읽어서 전달하는 역할을 하는 메소드(읽기 전용)
    * Setter(변경자): 외부에서 전달된 값을 받아, 내부 필드의 값을 설정또는 변경하는 역할을 하는 메소드*/
