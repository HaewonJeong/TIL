package com.ohgraffers.section01.array;
...
public class Application2 {
    ...
    public static void main(String[] args) {
        ...
        int[] iarr4 = {11, 22, 33, 44, 55}; //선언과 동시에 할당하는 경우만 new 세팅

        /*값을 넣지 않으면 기본값으로 채워진다.
        * 점수는 '0', 실수는 '0.0', 논리형은 'false', 문자형은 (\u0000), 참조형은 null*/
        for(int i=0; i< iarr.length; i++){
            System.out.println(i+"빈 인덱스의 값: "+iarr[i]);
        }
