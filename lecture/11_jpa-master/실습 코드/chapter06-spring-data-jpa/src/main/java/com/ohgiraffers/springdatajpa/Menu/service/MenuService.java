...
@Service
@RequiredArgsConstructor  //final 필드를 파라미터를 받는 생성자를 자동 생성(Lombok)
public class MenuService {
    ...
    public List<MenuResponseDTO> findByMenuPriceGreaterThanOrderByMenuPrice(Integer menuPrice){
        //쿼리 메소드 호출
    ...
    public MenuResponseDTO registMenu(MenuRequestDTO requestDTO){
        ...
        //내부적으로 EntityManager.persist() 호출 되어 영속성 컨텍스트로 들어간다.
