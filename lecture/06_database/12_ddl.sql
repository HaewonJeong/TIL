...
-- AUTO INCREMENT
-- INSERT 시 PRIMARY KEY에 해당하는 컬럼에 자동으로 번호를 발생시켜 저장할 수 있다.
...
CREATE TABLE IF NOT EXISTS tb4( -- 테이블 생성
	pk INT AUTO_INCREMENT PRIMARY KEY,
    fk INT,
    col1 VARCHAR(255),
    CHECK (col1 IN('Y', 'N'))
...
INSERT INTO tb4 VALUES(NULL, 10, 'Y'),  (NULL, 20, 'Y'), (NULL, 20, 'N');

SELECT * FROM tb4;

TRUNCATE TABLE tb4; -- tb4를 초기화 하겠습니다.

INSERT INTO tb4 VALUES(NULL, 10, 'Y'),  (NULL, 20, 'N');

-- CREATE TABLE : 테이블 생성
-- ALTER TABLE(ADD, DROP, CHANGE, MODIFY...) : 테이블 수정
-- DROP TABLE 
-- TRUNCATE TABLE
